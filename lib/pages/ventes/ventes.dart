...
import 'package:economat_kisantu/pages/ventes/ventes_controller.dart';
...
class Ventes extends StatelessWidget {
  ...
  //
  String operation = "";
  RxList operations = ["Facture", "encaissement"].obs;
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: Obx(
                                    () => DropdownButton(
                                      value: indexClient.value,
                                      onChanged: (c) {
                                        //
                                        indexClient.value = c as int;
                                        client = clients[c as int];
                                      },
                                      items: List.generate(clients.length,
                                          (index) {
                                        return DropdownMenuItem(
                                          value: index,
                                          child: Text(
                                            "${clients[index]['nom_contact']} (${clients[index]['raison_social']})",
                                          ),
                                        );
                                      }),
                                    ),
